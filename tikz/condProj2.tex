\begin{tikzpicture}[scale = 1, rotate = 0]
	...
	\coordinate (W1) at ($(V)!1.28!-14:(P)$);
	\coordinate (W2) at ($(V)!1.27!-2:(P)$);
	\coordinate (W3) at ($(V)!1.29!14:(P)$);
	...
	\def\regionB{
		(W1)
		.. controls ++(90:-0.2) and ++(120:0.2) .. (W2)
		.. controls ++(120:-0.2) and ++(140:0.2) .. (W3)
		.. controls ++(140:-0.2) and ++(10:3) ..
		cycle;

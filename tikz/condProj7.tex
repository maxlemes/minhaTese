\begin{tikzpicture}[scale = 0.8]
	...
	\coordinate (V) at (8,6);
	\coordinate (P) at (5,7);
	\coordinate (W) at ($(V)!1.2!10:(P)$);

	\coordinate (W1) at ($(V)!1!0:(P)$);
	\coordinate (W2) at ($(V)!1.28!10:(P)$);
	\coordinate (W3) at ($(V)!1.16!23:(P)$);
	...
	\def\regionB{
		(W1)
		.. controls ++(190:-0.2) and ++(90:0.3) .. (W2)
		.. controls ++(90:-0.3) and ++(300:-0.1) .. (W3)
		.. controls ++(300:0.1) and ++( 20:4) ..
		cycle;
	...
	\draw [line width=0.8pt] (N) -- ($(N)!2cm! 90:(V)$) node[right] {$\pi$};

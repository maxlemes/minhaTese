\begin{tikzpicture}[scale = 0.8]
	...
	\coordinate (V) at (6,3);
	\coordinate (P) at (3.5,4.1);
	\coordinate (W) at ($(V)!1.05!-5:(P)$);

	\coordinate (W1) at ($(V)!1.01!-16:(P)$);
	\coordinate (W2) at ($(V)!1.085!-5:(P)$);
	\coordinate (W3) at ($(V)!1.01!6:(P)$);
	...
	(2,7)
	    -- (5,7) 
	    -- (3,3)
		.. controls ++(60:-1) and ++(270: 1) .. (0,4)
		.. controls ++(270:-1) and ++(180:1) .. (2,7)
		;
	}
	...
	\def\regionB{
		(W1)
		.. controls ++(190:-0.2) and ++(60:0.3) .. (W2)
		.. controls ++(60:-0.3) and ++(280:-0.1) .. (W3)
		.. controls ++(280:0.1) and ++(280:4) ..
		cycle;
	...
	\draw [line width=0.8pt] (N) -- ($(N)!5cm! 90:(V)$) node[right] {$\pi$};
	\draw [line width=0.8pt] (N) -- ($(N)!2cm!-90:(V)$);
	...
	\matrix [draw,anchor=south west] at (current bounding box.north east) {

\begin{tikzpicture}[scale = 1]
	...
	\coordinate (W) at ($(V)!1.12!-6.5:(P)$);

	\coordinate (W1) at ($(V)!1.08!-11:(P)$);
	\coordinate (W2) at ($(V)!1.12!-6.5:(P)$);
	\coordinate (W3) at ($(V)!1.11!7:(P)$);
	\coordinate (W4) at ($(V)!1.03!16:(P)$);
	\coordinate (W5) at ($(V)!0.97!21:(P)$);
	\coordinate (U) at (5.5,3);
	...
	\def\regionB{
		(W1)
		.. controls ++(180:0.1) and ++(190:-0.2) .. (W2)
		.. controls ++(190:0.2) and ++(250:-0.5) .. (W3)
	%	.. controls ++(250:0.5) and ++(300:-0.2) .. (W4)
		.. controls ++(250:0.2) and ++(320:-0.2) .. (W5)
	...
	\begin{scope}[shift={(5cm,-1cm)},rotate=70]
		...
		\draw[fill=red, opacity = 0.5,line width=0.8pt,shift={(5cm,-1cm)},rotate=70] (V) circle [radius=3.9cm];
	\end{scope}
